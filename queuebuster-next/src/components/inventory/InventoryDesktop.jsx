...
import styles from '../../styles/inventory/inventoryDesktop.module.css'
...
const InventoryDesktop = () => {
    ...
    const { inventoryPageHeadingP1, inventoryPageHeadingP2, inventoryPageHeadingP3, inventoryTypingText1, inventoryTypingText2, inventoryTypingText3, inventoryPageDesc, businessTransformingWith, deadStock, stockTracking, industriesWeServe, FAQInventory } = content.features
    ...
    return (
        <>
            ...
            <div className={styles.section_one}>
                ...
                <div className={styles.right_container}>
                    <div className={styles.section1_image_container}>
                        <Image src='https://quebuster.s3.ap-south-1.amazonaws.com/website/assets/inventory/inventory-hero-img.webp' alt='inventory management software' fill />
                    </div>
                </div>
            </div>
            ...
            <OtherHighlights Highlights={inventoryHighlights} Banner={inventoryBanner} bannerHeight={'44.5rem'} bannerWidth={'57.25rem'} setDemoModal={setDemoModal} setHeading={setHeading} />
            ...
            <RewardingSection
                ...
                heading={businessTransformingWith}
                strokeImage={'/assets/strokes_svg/business_hl.svg'}
                altText={'queuebuster inventory'}
            ...
            <div>
                <FrequentQuestions FaqTableData={inventoryFAQ} heading={FAQInventory} />
            </div>
