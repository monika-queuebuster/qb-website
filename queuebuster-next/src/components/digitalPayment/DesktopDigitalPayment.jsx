...
import styles from '../../styles/digitalPayments/DesktopDigitalPayment.module.css';
...
const DesktopDigitalPayment = () => {
    ...
    return (
        <>
            ...
            <div className={styles.section_one}>
                ...
                <div className={styles.right_container}>
                    <div className={styles.section1_image_container}>
                        <Image src='https://quebuster.s3.ap-south-1.amazonaws.com/website/assets/payment/payments-hero-img.webp' alt='hero image' fill />
                    </div>
                </div>
            </div>
            ...
            <OtherHighlights Highlights={paymentHighlights} Banner={paymentBanner} bannerHeight={'43.5rem'} bannerWidth={'52.25rem'} setDemoModal={setDemoModal} setHeading={setHeading} />

            <RewardingSection
                Text1={worthOfTransactions}
                Text2={yoyGrowth}
                Number1={`$1.5 Trillion`}
                Number2={`13.75 %`}
                // BrText2={"Growing Rapidly"}
                heading={<>{indiaWorldLeader}</>}
            ...
            <div>
                <FrequentQuestions FaqTableData={paymentFAQ} heading={paymentFAQHeading} />
            </div>
...
export default DesktopDigitalPayment