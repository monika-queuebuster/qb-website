...
const GetFreeDemoMobile = ({ isOpen, closeModal }) => {
   ...
   return (
      <div className={styles.modal_size} style={{ padding: "4rem 2rem 10rem 2rem", height: "100vh" }} >
               ...
               <div>
                  {
                     showOtpBox && !userVerified ?
                        <div className={styles.form_container}>
                           <h1 className={styles.form_heading}>Interested in getting in touch with QueueBuster POS team ?</h1>
                           <p className={styles.form_desc}>Simply submit your details for our experts to reach out</p>
                           ...
                           <div style={{ display: 'flex', flexDirection: 'column', marginTop: '5rem', alignItems: "center" }}>
                              ...
                              <div style={{ display: "flex", flexDirection: "column", alignItems: "center", marginTop: "3rem", width: "80%" }}>
         ...
         </div>
         {
            ...
            <div className={styles.modal_footer_container}>
               ...
               <div className={styles.icon_container}>
                  <div className={styles.merchants_icons} style={{ height: "2rem", width: "8rem" }}><Image src="/assets/demo-relaxo.png" alt="relaxo" fill /></div>
                  <div className={styles.merchants_icons} style={{ height: "3rem", width: "8rem" }}><Image src="/assets/demo-happilo.png" alt="happilo" fill /></div>
                  <div className={styles.merchants_icons} style={{ height: "3rem", width: "8rem" }}><Image src="/assets/demo-heineken.png" alt="heineken" fill /></div>
                  <div className={styles.merchants_icons} style={{ height: "3rem", width: "8rem" }}><Image src="/assets/newClients/Client-07.webp" alt="cremica" fill /></div>
                  <div className={styles.merchants_icons} style={{ height: "3rem", width: "6rem" }}><Image src="/assets/demo-tajstats.png" alt="taj stats" fill /></div>
                  <div className={styles.merchants_icons} style={{ height: "4rem", width: "4rem" }}><Image src="/assets/demo-itc.png" alt="itc" fill /></div>
                  <div className={styles.merchants_icons} style={{ height: "3rem", width: "10rem" }}><Image src="/assets/newClients/Client-43.webp" alt="canabeans" fill /></div>
                  <div className={styles.merchants_icons} style={{ height: "4rem", width: "10rem" }}><Image src="/assets/newClients/Client-01.webp" alt="hul" fill /></div>
               </div>
            </div>
         }
      </div>
...
export default GetFreeDemoMobile