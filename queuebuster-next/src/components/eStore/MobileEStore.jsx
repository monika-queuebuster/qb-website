...
import styles from '../../styles/eStore/MobileEstore.module.css';
...
import { eStore, estoreHighlights, eStoreFAQ, eStoreBanner } from '../../constants/features'
    ...
    <>
      ...
      <div className={styles.section_one}>
        <div className={styles.left_container}>
          <h1>
            <span className={styles.black_text}>{estorePageHeadingP1} {estorePageHeadingP2} {estorePageHeadingP3}</span><br />
            <span className={styles.blue_text}><ReactTyped strings={[estoreTypingText1, estoreTypingText2]} typeSpeed={300} loop /></span>
          </h1>
          <div className={styles.right_container}>
            <div className={styles.section1_image_container}>
              <Image src='https://quebuster.s3.ap-south-1.amazonaws.com/website/assets/online-store/estore-hero-img.webp' alt='estore hero image' fill />
            </div>
          </div>
      ...
      <div className={styles.highlights_section}>
        <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center' }}><h3 className={styles.highlights_sec_heading}>Other Highlights</h3><div className={styles.highlights_sec_stroke}><Image src='/assets/strokes_svg/features_hl.svg' alt='features stroke' fill /></div></div>
        <div style={{ display: 'flex', flexWrap: 'wrap', gap: '2rem' }} >
          {
            estoreHighlights?.map((ele) => {
              return (
      ...
      <div className={styles.section_four}>
        <div style={{ display: 'flex', justifyContent: 'end' }}><div className={styles.section4_image_container}>
          <Image src={eStoreBanner?.image} alt={eStoreBanner?.altText} fill />
        </div>
        </div>
        <div style={{ padding: '3rem 2rem' }}>
          <div className={styles.section4_left_side}>
            <h4 className={styles.section_four_heading}>{eStoreBanner?.title}</h4>
            <p className={styles.section_four_content}>{eStoreBanner?.content}</p>
          </div>
      ...
      <div className={styles.section_five}>
        <div className={styles.section5_container}>
          ...
          <div className={styles.section5_right_container}>
            <div><h3 className={styles.rewarding_section_heading}>{businessThrive}</h3><div className={styles.business_stroke_img}><Image src='/assets/strokes_svg/business_hl.svg' alt='business stroke' fill /></div></div>

            <div style={{ display: 'flex', gap: '3rem', margin: '2rem 0 3.75rem 0', width: '100%', justifyContent: 'space-between' }}>
              <div>
                <p className={styles.LC_number}>39%</p>
                <p className={styles.LC_heading}>{incrementalRevenue}</p>
              </div>
              <div>
                <p className={styles.LC_number}>45%</p>
                <p className={styles.LC_heading}>{moreCustomers}</p>
              </div>
            </div>
      ...
      <div className={styles.mobile_industries_section}>
        <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center' }}><h3 className={styles.industry_heading}>{industriesWeServe}</h3> <div className={styles.industries_stroke_img}><Image src='/assets/strokes_svg/industries_hl.svg' alt='industries' fill /></div></div>
        <NewIndustryCards view='mobile' />
      </div>

      <div className={styles.section_six}>
        <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center' }}><h3 className={styles.highlights_sec_heading}>{testimonialHeadText}</h3><div className={styles.testimonials_stroke_img}><Image src='/assets/strokes_svg/testimonials_hl.svg' alt='features stroke' fill /></div></div>
      ...
      <div>
        <FAQmobile FaqTableData={eStoreFAQ} width={"auto"} heading={FAQEstore} />
      </div>
