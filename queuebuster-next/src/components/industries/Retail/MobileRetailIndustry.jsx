...
import styles from '../../../styles/Industries/retail/MobileRetail.module.css';
...
const MobileRetailIndustry = () => {
   ...
   const { outletHeading, industryQqPOSHeading, glimpsesHeading } = content.commonIndustryHeading
   ...
   return (
      <>
         ...
         <div className={styles.ecstatic_section}>
            ...
            <MobileEcstatic ecstatic={reatilEcstatic} />
         </div>
         ...
         <div className={styles.outlet_section}>
            <div className={styles.section_heading}><h3>{outletHeading}</h3><div className={styles.heading_stroke} style={{ width: '12rem' }}><Image src='/assets/industry/restaurant/features_hl 4.svg' alt='stroke' fill /></div></div>
         ...
         <div className={styles.testimonial_section}>
            <div className={styles.section_heading}><h3>{testimonialHeadText}</h3> <div className={styles.heading_stroke} style={{ width: '12rem' }}><Image src='/assets/strokes_svg/testimonials_hl.svg' alt='industries' fill /></div></div>
         ...
         <div style={{ margin: '4rem 0rem' }}>
            <FAQmobile FaqTableData={retailFAQ} width={"auto"} heading={faqHeading} />
         </div>
