...
import styles from '../../../styles/Industries/grocery/MobileGrocery.module.css';
...
const mobileGroceryIndustry = () => {
   const { commonMarqueTitle } = content
   const { industryQqPOSHeading, glimpsesHeading, outletHeading } = content.commonIndustryHeading;
   const { blueFoldTitle, blueFoldDesc, groceryFAQHeading, groceryPOS, groceryHeroSectionDesc, groceryTypingText1, groceryTypingText2, groceryTypingText3, groceryEcstaticHeading } = content.groceryIndustry
      ...
      <>
         ...
         <div className={styles.hero_section}>
            <div className={styles.image_part}>
               <div className={styles.hero_image_container}><Image src='https://quebuster.s3.ap-south-1.amazonaws.com/website/assets/grocery/hero-img+(2).webp' alt='grocery hero image' fill /></div>
            </div>
         ...
         <div className={styles.ecstatic_section}>
            <div className={styles.section_heading}><h3>{groceryEcstaticHeading}</h3><div className={styles.heading_stroke} style={{ width: '18rem' }}><Image src='/assets/industry/restaurant/features_hl.svg' alt='stroke' fill /></div></div>
            <MobileEcstatic ecstatic={groceryEcstatic} />
         </div>
         ...
         <div style={{ margin: '4rem 0rem' }}>
            <FAQmobile FaqTableData={groceryFAQ} width={"auto"} heading={groceryFAQHeading} />
         </div>
...
export default mobileGroceryIndustry