...
import styles from '../../../styles/Industries/salon/DesktopSalon.module.css';
      ...
      <>
         ...
         <div className={styles.hero_section}>
            ...
            <div className={styles.image_part}>
               <div className={styles.hero_image_container}><Image src='/assets/industry/spa&salon/hero-img.webp' alt='restaurant hero image' fill /></div>
            </div>
         </div>
         ...
         <div className={styles.ecstatic_section}>
            ...
            <EcstaticsFeature ecstatic={salonEcstatic} />
         </div>
         <div className={styles.features_section}>
            ...
            <IndustryFeatures features={salonFeatures} cardMaxHeight="38rem" />
         </div>
         ...
         <div className={styles.blue_fold_section}>
            <BlueFoldBanner
               img={'https://quebuster.s3.ap-south-1.amazonaws.com/website/assets/spa/salon-blue-fold.webp'}
               imgHeight='40rem'
               imgWidth='62rem'
