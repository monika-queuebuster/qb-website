...
import styles from '../../../styles/Industries/electronics/MobileElectronics.module.css';
...
const MobileElectronicIndustry = () => {
      ...
      <>
         ...
         <div className={styles.hero_section}>
            <div className={styles.image_part}>
               <div className={styles.hero_image_container}><Image src='https://quebuster.s3.ap-south-1.amazonaws.com/website/assets/electronics/elec-hero-img.webp' alt='restaurant hero image' fill /></div>
            </div>
         ...
         <div className={styles.ecstatic_section}>
            ...
            <MobileEcstatic ecstatic={electronicsEcstatic} />
         </div>
         ...
         <div style={{ margin: '4rem 0rem' }}>
            <FAQmobile FaqTableData={electronicsFAQ} width={"auto"} heading={faqHeading} />
         </div>
...
export default MobileElectronicIndustry