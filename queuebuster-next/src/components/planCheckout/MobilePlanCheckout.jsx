...
import styles from '../../styles/planCheckout/MobilePlanCheckout.module.css'
...
const MobilePlanCheckout = ({planSelected}) => {
  ...
  const [totalAmount, setTotalAmount] = useState("117998");
      ...
      <div className={styles.summary_section}>
        ...
        <div className={styles.subscription_summary}>
          <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center" }}>
            ...
            <div>
              <div style={{ textAlign: "right" }}>{billing === "yearly" ? "₹ 11998" : "₹ 999"}</div>
...

          {
            ...
            <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginTop: "2rem" }}>
              ...
              <div>
                <div style={{ textAlign: "right" }}>-₹ 1999</div>
              </div>
            </div>
          }
        </div>
        ...
        <div className={styles.total_summary}>
          <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center" }}>
            ...
            <div>
              <div style={{ textAlign: "right" }}>{billing === "yearly" ? "₹ 9999" : "₹ 999"}</div>
              <div style={{ font: "normal normal normal 1.4rem/2rem Inter", color: "#747474", textAlign: "right" }}> {billing === "yearly" ? "₹ 1799" : "₹ 179.82"}</div>
            </div>
          </div>
          <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginTop: "2rem" }}>
            <div style={{ font: "normal normal 500 1.8rem/3rem Inter", color: "#2A6AB4" }}>Total Amount</div>
            <div>
              <div style={{ font: "normal normal 500 1.8rem/3rem Inter", color: "#2A6AB4", textAlign: "right" }}> {billing === "yearly" ? "₹ 117998" : "₹ 1178.82"}</div>
            </div>
          </div>
        </div>
...
export default MobilePlanCheckout