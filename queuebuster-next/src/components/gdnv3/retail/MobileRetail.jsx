...
import { features, retailOutletTypes } from '@/constants/industry'
...
const DesktopRetail = () => {
    ...
    return (
        <>
            <GDNV3 setRemoveContent={setRemoveContent} heading={"Retail Store Management"} />
            {
                !removeContent &&
                <>
                    {/* <div className={styles.grid_outer_container}>
                        <div className={styles.left_side_grid}>
                            <div className={styles.img1_container}><Image src="/assets/gdnv3/retail/img1.png" alt="retail gdnv3" fill /></div>
                            <div className={styles.left_bottom_grid}>
                                <div className={styles.img3_container}><Image src="/assets/gdnv3/retail/img3.png" alt="retail gdnv3" fill /></div>
                                <div className={styles.img4_container}><Image src="/assets/gdnv3/retail/img4.png" alt="retail gdnv3" fill /></div>
                            </div>
                        </div>
                    </div> */}
