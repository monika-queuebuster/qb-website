...
import { features, restaurantOutletTypes } from '@/constants/industry'
...
const DesktopRestaurant = () => {
    const { commonMarqueTitle } = content
    const [removeContent, setRemoveContent] = useState(false);
    
    return (
        <>
            <GDNV3 setRemoveContent={setRemoveContent} mainHeading={"Restaurant Billing Software for"} heading={"Cafe, Fine Dine & Pizzeria"} />
            {
                !removeContent &&
                <>
                    <div className={styles.slider_section} style={{ marginTop: "10rem" }}>
                        ...
                        <Gdnv3Slider outletTypes={restaurantOutletTypes} cards={4} />
                    </div>
...
export default DesktopRestaurant