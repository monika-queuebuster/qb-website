...
const MobileContactUs = () => {
   ...
   useEffect(() => {
      if (phoneNumber?.length > 10) {
         setErrors({ ...errors, phoneNumberError: "Invalid Number" });
      }
      else {
      ...
      <>
         ...
         <div className={styles.blue_card_section}>
            ...
            <div>
               ...
               <div>
                  ...
                  <p className={styles.blue_card_content}>Unit No. <b>401, 4th Floor, Pegasus One Tower,</b> Plot No. A-10, Sector - 68, Noida, Uttar Pradesh - 201307</p>
               </div>
            </div>
         </div>
         ...
         <div className={styles.map_container}>
            <iframe
               ...
               src={`https://www.google.com/maps/embed/v1/place?q=QueueBuster&key=AIzaSyBFw0Qbyq9zTFTd-tUY6dZWTgaQzuU17R8&zoom=10`}
               title="Map"
            ></iframe>
         </div>
