...
import styles from '../../styles/khata/DesktopKhata.module.css';
...
const DesktopKhata = () => {
  ...
  const { khataHeading, khataTypingText1, khataTypingText2, khataTypingText3, khataPageDesc, sustainableGrowth, reductionInBadDebts, timeSaving, FAQkhata, industriesWeServe } = content.features
  const router = Router;
  ...
  return (
    <>
      ...
      <div className={styles.section_one}>
        ...
        <div className={styles.right_container}>
          <div className={styles.section1_image_container}>
            <Image src='https://quebuster.s3.ap-south-1.amazonaws.com/website/assets/khata/khata-hero-img.webp' alt='hero image' fill />
          </div>
        </div>
      </div>
      ...
      <OtherHighlights Highlights={khataHighlights} Banner={khataBanner} bannerHeight={'49.5rem'} bannerWidth={'64.25rem'} setDemoModal={setDemoModal} setHeading={setHeading} />

      <RewardingSection
        Text1={reductionInBadDebts}
        Text2={timeSaving}
        Number1={`71%`}
        Number2={`45 %`}
        // BrText2={"Growing Rapidly"}
        heading={<>{sustainableGrowth}</>}
        strokeImage={'/assets/strokes_svg/business_hl.svg'}
        altText={'queuebuster khata'}
      ...
      <div>
        <FrequentQuestions FaqTableData={khataFAQ} heading={FAQkhata} />
      </div>
