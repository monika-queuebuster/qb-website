...
const MobileHomeApp = () => {
    ...
    const { heroHeading, heroDesc } = content.homeAppliances
    ...
    return (
        <div>
            ...
            <div className={styles.features_section}>
                ...
                <OutletFeatures features={homeAppFeatures} mobileView={true} setDemoModal={setDemoModal} setHeading={setHeading} />
            </div>

            <div className={styles.other_features_section}>
                <div className={styles.text_side}>
                    <div className={styles.section_heading}><h3>Other Important Features for Home Appliances Stores Billing Software</h3><div className={styles.other_features_stroke} style={{ width: '22rem' }}><Image src='/assets/industry/restaurant/features_hl.svg' alt='stroke' fill /></div></div>
                    <p className={styles.other_features_Desc}>QueueBuster offers a range of features that enable you to sell online, simplify your billing process, and offer flexible payment options to your customers. With our online selling feature, you can expand your customer base beyond your physical store and reach more buyers.<br />
            ...
            <FAQmobile FaqTableData={homeAppFAQ} width={"auto"} heading={"FAQ for Home Appliances POS Billing Software"} />
