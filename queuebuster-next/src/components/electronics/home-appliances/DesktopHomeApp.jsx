...
import { HomeAppwhyQB, homeAppFAQ, homeAppFeatures, homeAppOtherFeatures } from '@/constants/outlets';
    ...
    return (
        <div>
            ...
            <div className={styles.hero_stack_container}>
                ...
                <div className={styles.hero_section}>
                    ...
                    <div className={styles.hero_img_container}>
                        <div className={styles.hero_img} style={{ height: "35rem" }}><Image src="/assets/electronics/home-appliances/hero-img.png" alt="fine dine" fill /></div>
                    </div>
                </div>
            </div>
            ...
            <div className={styles.features_section}>
                ...
                <OutletFeatures features={homeAppFeatures} setDemoModal={setDemoModal} setHeading={setHeading} />
            </div>

            <div className={styles.other_features_section}>
                <div className={styles.text_side}>
                    <div className={styles.section_heading} style={{ margin: '0' }}><h3 style={{ textAlign: "left" }}>Other Important Features for Home Appliances Stores Billing Software</h3><div className={styles.other_features_stroke} style={{ width: '22rem' }}><Image src='/assets/industry/restaurant/features_hl.svg' alt='stroke' fill /></div></div>
                    <p className={styles.other_features_Desc}>QueueBuster offers a range of features that enable you to sell online, simplify your billing process, and offer flexible payment options to your customers. With our online selling feature, you can expand your customer base beyond your physical store and reach more buyers.<br /><br />
                        Expand your business and reach customers beyond your physical store with our online selling feature.<br />
                        Simplify your billing process and reduce errors with our efficient barcode scanning technology.<br />
                        Offer your customers the flexibility to pay for their purchases in easy installments with our brand and bank EMI options.<br />
                    </p>
                </div>
                <div className={styles.box_side}>
                    {
                        homeAppOtherFeatures?.map((ele, idx) => {
                            return (
            ...
            <div style={{ marginTop: "6rem" }}>
                <FrequentQuestions FaqTableData={homeAppFAQ} heading={"FAQ for Home Appliances POS Billing Software"} />
            </div>

            <div className={styles.why_qb_section}>
                <h2>How QueueBuster Home Appliances POS Billing Software Helps You Manage Your Store Better?</h2>
                <div className={styles.why_container}>
                    <div className={styles.content_part}>
                        <p className={styles.why_qb_desc}>Success hinges not only on cutting-edge gadgets but also on the sophistication of the operational backbone. QueueBuster Electronics Store Billing Software emerges as the vanguard of innovation, offering a holistic solution that reshapes the entire retail experience.</p><br />
                        {
                            HomeAppwhyQB?.map((ele) => {
                                return (
